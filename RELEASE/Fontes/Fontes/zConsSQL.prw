...
Static Function fCriaMsNew()
    ...
    For nAtual := 1 To Len(aStruAux)
        ...
        aStrCpo := FWSX3Util():GetFieldStruct( cCampoAtu )
        ...
        If SX3->(DbSeek(cCampoAtu))
            ...
            aAdd(aHeadAux,{ getsx3cache(cCampoAtU,"X3_TITULO"),    aStrCpo[1],    aStrCpo[5],    aStrCpo[3],    aStrCpo[4],    ".F.",    ".F.",    aStrCpo[2],    "",    ""})
        ...
        Else
            //Cabeçalho ...    Titulo                                    Campo        Mask    Tamanho                    Dec                        Valid    Usado    Tip                        F3    CBOX
            aAdd(aHeadAux,{    Capital(StrTran(cCampoAtu, '_', ' ')),    cCampoAtu,    "",        aStrCpo[3],    aStrCpo[4],    ".F.",    ".F.",    aStruAux[nAtual][2],    "",    ""})
