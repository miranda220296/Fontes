...
/*/{Protheus.doc} F1300602
Fonte para criação de consulta
@author henrique.toyada
@since 31/10/2017
@project MAN0000007423048_EF_006
@type function
/*/
user function F1300602()
return
...
User Function FSRCL4()
	...
	If !(EMPTY(FwFldGet("PAH_FILPOS")))
		cQuery += " AND RCL.RCL_FILIAL = '" + FwFldGet("PAH_FILPOS") + "' "
	EndIf
...
Static Function OK()
	...
	cFilF3 	:= (cAliasF3)->RCL_FILIAL
	cCodF3	:= (cAliasF3)->RCL_POSTO
Return
...
Static Function VisualF3(oBrowse)
	...
	AxVisual(cCadastro,RCL->(Recno()),2)
Return
 
 
/*/{Protheus.doc} FSRCL4R1
//TODO Descrição auto-gerada.
@author henrique.toyada
@since 31/10/2017
@project MAN0000007423048_EF_006
