...
/*
{Protheus.doc} F1200713(cId, cObs)
Grava ocorrencia no array principal.
@Author		Paulo Krüger
@Since		29/08/2017
@Version	P12.7
@Project    MAN00000462901_EF_001
@Paramc		Id, Id de integração 
@Param		cObs, Observações
@Param		nPos, Posição do array principal
@Return Nil
*/
User Function F1200713(cId, cObs, nPos)

If nPos > 0
	While aProdSel[nPos][IDINTSOLIC] == cId
