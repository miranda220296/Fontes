...
/*/
//--------------------------------------------------------------------
User Function UPD9000( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD9000" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD9000" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
If !AcheiSX3("SR7","R7_XDTEAC")
   cOrd1 := UltimoSX3("SR7") 
   cOrd1 := Soma1(cOrd1) 
Else
   cOrd1 := QualOrdemSX3("SR7","R7_XDTEAC")
Endif

aAdd ( aSX3, { ;
	{ 'SR7'											, .T. }, ; //X3_ARQUIVO
	{ cOrd1     			  	 	                , .T. }, ; //X3_ORDEM
	{ 'R7_XDTEAC'									, .T. }, ; //X3_CAMPO
	{ 'D'											, .T. }, ; //X3_TIPO
	{ 8											    , .T. }, ; //X3_TAMANHO
	{ 0											    , .T. }, ; //X3_DECIMAL
	{ 'DtEfAcConv '									, .T. }, ; //X3_TITULO
	{ 'DtEfAcConv '									, .T. }, ; //X3_TITSPA
	{ 'DtEfAcConv '									, .T. }, ; //X3_TITENG
	{ 'DtEfAcConv '									, .T. }, ; //X3_DESCRIC
	{ 'DtEfAcConv '									, .T. }, ; //X3_DESCSPA
	{ 'DtEfAcConv '     							, .T. }, ; //X3_DESCENG
	{ '@D'											, .T. }, ; //X3_PICTURE
	{ ''											, .T. }, ; //X3_VALID
	{ 'CCCCCCCCCCCCCCa'								, .T. }, ; //X3_USADO
	{ ''											, .T. }, ; //X3_RELACAO
	{ ''											, .T. }, ; //X3_F3
	{ 1											    , .T. }, ; //X3_NIVEL
	{ 'â– â””'										, .T. }, ; //X3_RESERV
...
If !AcheiSX3("SR7","R7_XDSC")
   cOrd1 := UltimoSX3("SR7") 
   cOrd1 := Soma1(cOrd1) 
Else
   cOrd1 := QualOrdemSX3("SR7","R7_XDSC")
Endif
...
aAdd( aSX3, { ;
	...
	{ 'Detalhamento'										, .T. }, ; //X3_DESCRIC
	{ 'Detalhamento'										, .T. }, ; //X3_DESCSPA
	{ 'Detalhamento'     									, .T. }, ; //X3_DESCENG
	{ '@!'										, .T. }, ; //X3_PICTURE
	{ ''											, .T. }, ; //X3_VALID
	{ 'CCCCCCCCCCCCCCa'									, .T. }, ; //X3_USADO
	{ ''											, .T. }, ; //X3_RELACAO
...
If !AcheiSX3("TNY","TNY_XTPAT")
   cOrd1 := UltimoSX3("TNY") 
   cOrd1 := Soma1(cOrd1) 
Else
   cOrd1 := U_QualOrdemSX3("TNY","TNY_XTPAT")
Endif

aAdd( aSX3, { ;
	{ 'TNY'											, .T. }, ; //X3_ARQUIVO
	{ cOrd1											, .T. }, ; //X3_ORDEM
	{ 'TNY_XTPAT'										, .T. }, ; //X3_CAMPO
	{ 'C'											, .T. }, ; //X3_TIPO
	{ 1											, .T. }, ; //X3_TAMANHO
	{ 0											, .T. }, ; //X3_DECIMAL
	{ 'TpAcidTransito'										, .T. }, ; //X3_TITULO
	{ 'TpAcidTransito'										, .T. }, ; //X3_TITSPA
	{ 'TpAcidTransito'										, .T. }, ; //X3_TITENG
	{ 'TpAcidTransito'										, .T. }, ; //X3_DESCRIC
	{ 'TpAcidTransito'										, .T. }, ; //X3_DESCSPA
	{ 'TpAcidTransito'     									, .T. }, ; //X3_DESCENG
	{ '@!'											, .T. }, ; //X3_PICTURE
	{ ''											, .T. }, ; //X3_VALID
	{ 'CCCCCCCCCCCCCCa'									, .T. }, ; //X3_USADO
	{ 'Vazio() .Or. Pertence("123")'											, .T. }, ; //X3_RELACAO
	{ ''											, .T. }, ; //X3_F3
	{ 1											, .T. }, ; //X3_NIVEL
	{ 'â– â””'										, .T. }, ; //X3_RESERV
	{ ''											, .T. }, ; //X3_CHECK
	...
	{ ''											, .T. }, ; //X3_OBRIGAT
	{ ''											, .T. }, ; //X3_VLDUSER
	{ '1=Atropelamento;2=Colisão;3=Outros'			, .T. }, ; //X3_CBOX
	{ ''											, .T. }, ; //X3_CBOXSPA
	{ ''											, .T. }, ; //X3_CBOXENG
	{ ''											, .T. }, ; //X3_PICTVAR
	{ ''											, .T. }, ; //X3_WHEN
...
If !AcheiSX3("TNY","TNY_ORIALT")
   cOrd1 := UltimoSX3("TNY") 
   cOrd1 := Soma1(cOrd1) 
Else
   cOrd1 := U_QualOrdemSX3("TNY","TNY_ORIALT")
Endif

aAdd( aSX3, { ;
	{ 'TNY'											, .T. }, ; //X3_ARQUIVO
	{ cOrd1											, .T. }, ; //X3_ORDEM
	{ 'TNY_ORIALT'										, .T. }, ; //X3_CAMPO
	{ 'C'											, .T. }, ; //X3_TIPO
	{ 1											, .T. }, ; //X3_TAMANHO
	{ 0											, .T. }, ; //X3_DECIMAL
	{ 'OrigRetif'										, .T. }, ; //X3_TITULO
	{ 'OrigRetif'										, .T. }, ; //X3_TITSPA
	{ 'OrigRetif'										, .T. }, ; //X3_TITENG
	{ 'Origem Retif'										, .T. }, ; //X3_DESCRIC
	{ 'Origem Retif'										, .T. }, ; //X3_DESCSPA
	{ 'Origem Retif'     									, .T. }, ; //X3_DESCENG
	{ '@!'											, .T. }, ; //X3_PICTURE
	...
	{ ''											, .T. }, ; //X3_OBRIGAT
	{ ''											, .T. }, ; //X3_VLDUSER
	{ '1=Por iniciativa do empregador;2=Revisão Administrativa;3=Determinação Judicial'	, .T. }, ; //X3_CBOX
	{ ''											, .T. }, ; //X3_CBOXSPA
	{ ''											, .T. }, ; //X3_CBOXENG
	{ ''											, .T. }, ; //X3_PICTVAR
	{ ''											, .T. }, ; //X3_WHEN
...
If !AcheiSX3("TNY","TNY_XTPPRO")
   cOrd1 := UltimoSX3("TNY") 
   cOrd1 := Soma1(cOrd1) 
Else
   cOrd1 := U_QualOrdemSX3("TNY","TNY_XTPPRO")
Endif

aAdd( aSX3, { ;
	{ 'TNY'											, .T. }, ; //X3_ARQUIVO
	{ cOrd1											, .T. }, ; //X3_ORDEM
	{ 'TNY_XTPPRO'										, .T. }, ; //X3_CAMPO
	{ 'C'											, .T. }, ; //X3_TIPO
	{ 1											, .T. }, ; //X3_TAMANHO
	{ 0											, .T. }, ; //X3_DECIMAL
	{ 'Tipo Proc'										, .T. }, ; //X3_TITULO
	{ 'Tipo Proc'										, .T. }, ; //X3_TITSPA
	{ 'Tipo Proc'										, .T. }, ; //X3_TITENG
	{ 'Tipo Processo'										, .T. }, ; //X3_DESCRIC
	{ 'Tipo Processo'										, .T. }, ; //X3_DESCSPA
	{ 'Tipo Processo'     									, .T. }, ; //X3_DESCENG
	{ '9'											, .T. }, ; //X3_PICTURE
	{ 'Vazio() .Or. Pertence("123")'			, .T. }, ; //X3_VALID
	{ 'CCCCCCCCCCCCCCa'									, .T. }, ; //X3_USADO
	{ ''											, .T. }, ; //X3_RELACAO
	...
	{ ''											, .T. }, ; //X3_OBRIGAT
	{ ''											, .T. }, ; //X3_VLDUSER
	{ '1=Administrativo;2=Judicial;3=Num.Beneficio INSS'			, .T. }, ; //X3_CBOX
	{ ''											, .T. }, ; //X3_CBOXSPA
	{ ''											, .T. }, ; //X3_CBOXENG
	{ ''											, .T. }, ; //X3_PICTVAR
	{ ''											, .T. }, ; //X3_WHEN
...
If !AcheiSX3("TNY","TNY_NPRCJU")
   cOrd1 := UltimoSX3("TNY") 
   cOrd1 := Soma1(cOrd1) 
Else
   cOrd1 := U_QualOrdemSX3("TNY","TNY_NPRCJU")
Endif

aAdd( aSX3, { ;
	{ 'TNY'											, .T. }, ; //X3_ARQUIVO
	{ cOrd1											, .T. }, ; //X3_ORDEM
	{ 'TNY_NPRCJU'										, .T. }, ; //X3_CAMPO
	{ 'C'											, .T. }, ; //X3_TIPO
	{ 20											, .T. }, ; //X3_TAMANHO
	{ 0											, .T. }, ; //X3_DECIMAL
	{ 'Nr.Processo'										, .T. }, ; //X3_TITULO
	{ 'Nr.Processo'										, .T. }, ; //X3_TITSPA
	{ 'Nr.Processo'										, .T. }, ; //X3_TITENG
	{ 'Nr.Processo'										, .T. }, ; //X3_DESCRIC
	{ 'Nr.Processo'										, .T. }, ; //X3_DESCSPA
	{ 'Nr.Processo'     									, .T. }, ; //X3_DESCENG
	{ '@!'											, .T. }, ; //X3_PICTURE
	{ 'IF(M->TNY_XTPPRO<"2",VAZIO(),NAOVAZIO())'		, .T. }, ; //X3_VALID
	{ 'CCCCCCCCCCCCCCa'									, .T. }, ; //X3_USADO
	{ ''											, .T. }, ; //X3_RELACAO
	{ ''											, .T. }, ; //X3_F3
	{ 1											, .T. }, ; //X3_NIVEL
...
/////////////////////////////////////////////////////
// NESTE CAMPO SO FOI ALTERADO X3_BOX E A X3_VALID //
/////////////////////////////////////////////////////
If !AcheiSX3("SR8","R8_TPPROC")
   cOrd1 := UltimoSX3("SR8") 
   cOrd1 := Soma1(cOrd1) 
Else
   cOrd1 := QualOrdemSX3("SR8","R8_TPPROC")
Endif

aAdd( aSX3, { ;
	{ 'SR8'											, .T. }, ; //X3_ARQUIVO
	{ cOrd1											, .T. }, ; //X3_ORDEM
	{ 'R8_TPPROC'										, .T. }, ; //X3_CAMPO
	{ 'C'											, .T. }, ; //X3_TIPO
	{ 1											, .T. }, ; //X3_TAMANHO
	{ 0											, .T. }, ; //X3_DECIMAL
	{ 'Tp. Processo'										, .T. }, ; //X3_TITULO
	{ 'Tp. Proceso '										, .T. }, ; //X3_TITSPA
	{ 'Process Tp  '										, .T. }, ; //X3_TITENG
	{ 'Tipo de Processo         '										, .T. }, ; //X3_DESCRIC
	{ 'Tipo de proceso          '										, .T. }, ; //X3_DESCSPA
	{ 'Process Type             '     									, .T. }, ; //X3_DESCENG
	{ '9'											, .T. }, ; //X3_PICTURE
	{ 'Vazio() .Or. Pertence("123")'				, .T. }, ; //X3_VALID
	{ '€€€€€€€€€€€€€€ '									, .T. }, ; //X3_USADO
	{ ''											, .T. }, ; //X3_RELACAO
	...
	{ ''											, .T. }, ; //X3_VLDUSER
	{ '1=Administrativo;2=Judicial;3=Num.Beneficio INSS '	, .T. }, ; //X3_CBOX
	{ '1=Administrativo;2=Judicial;3=Num.Beneficio INSS '	, .T. }, ; //X3_CBOXSPA
	{ '1=Administrative;2=Judicial;3=INSS Benefit'			, .T. }, ; //X3_CBOXENG
	{ ''											, .T. }, ; //X3_PICTVAR
	{ ''											, .T. }, ; //X3_WHEN
	{ ''											, .T. }, ; //X3_INIBRW
	{ ''											, .T. }, ; //X3_GRPSXG
