...
/*/{Protheus.doc} F080FILB
//TODO -->> PE para filtrar os títulos a pagar apresentados no browse da rotina de Baixas a pagar manual ( chamada através do FINA080 - Baixas a pagar manual  )
...
Local _cOkPar := ''
	...
	IF !(_cOkPar == 'S')  .and. !( _cCusr $ _cCodU) 
			...
			IF !Empty(_cExprF)	
			   _cExprF := Substr(_cExprF,1, LEN(alltrim(_cExprF)) - 3) 
			endif   
