...
/*/{Protheus.doc} ANCTB103GR

Esse P.E Executa a gravação dos lançamentos
Ponto de entrada executado dentro da função de gravação de lançamentos contabeis (antes de gravar)
