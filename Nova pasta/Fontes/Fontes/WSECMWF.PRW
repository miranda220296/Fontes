...
Static cUrlFluig := SuperGetMV("FS_URLFLG", .F., "https://fluighml.rededor.com.br/webdesk/ECMWorkflowEngineService")

/* ===============================================================================
WSDL Location    https://fluighml.rededor.com.br/webdesk/ECMWorkflowEngineService?wsdl
Gerado em        04/24/19 /:11:35
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _MIAUXKK ; Return  // "dummy" function - Internal Use
...
BEGIN WSMETHOD
Conout("Inicio do método imporProcess")
...
Conout("Fim do método imporProcess")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método setDueDate")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método setDueDate")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método takeProcessTask")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método takeProcessTask")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getInstanceCardData")
...
Conout("Fim do método getInstanceCardData")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método createWorkFlowProcessVersion")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método createWorkFlowProcessVersion")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getCardValue")
...
Conout("Fim do método getCardValue")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAllProcessAvailableToExport")
...
Conout("Fim do método getAllProcessAvailableToExport")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método saveAndSendTask")
...
cSoap += U_XSoapValue("attachments", ::oWSsaveAndSendTaskattachments, oWSsaveAndSendTaskattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.,.F.)
...
Conout("Fim do método saveAndSendTask")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método setAutomaticDecisionClassic")
...
Conout("Fim do método setAutomaticDecisionClassic")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método importProcessWithCardAndRelatedDatasets")
...
Conout("Fim do método importProcessWithCardAndRelatedDatasets")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método calculateDeadLineHours")
...
Conout("Fim do método calculateDeadLineHours")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAllProcessAvailableToImport")
...
Conout("Fim do método getAllProcessAvailableToImport")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método cancelInstance")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método cancelInstance")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getActualThread")
...
Conout("Fim do método getActualThread")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getWorkFlowProcessVersion")
...
Conout("Fim do método getWorkFlowProcessVersion")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAvailableProcessOnDemand")
...
Conout("Fim do método getAvailableProcessOnDemand")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAvailableStatesDetail")
...
Conout("Fim do método getAvailableStatesDetail")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método exportProcessInZipFormat")
...
Conout("Fim do método exportProcessInZipFormat")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método importProcessWithCard")
...
Conout("Fim do método importProcessWithCard")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método saveAndSendTaskByReplacement")
...
Conout("Fim do método saveAndSendTaskByReplacement")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método startProcessClassic")
...
Conout("Fim do método startProcessClassic")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método cancelInstanceByReplacement")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método cancelInstanceByReplacement")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método calculateDeadLineTime")
...
Conout("Fim do método calculateDeadLineTime")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método simpleStartProcess")
...
Conout("Fim do método simpleStartProcess")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAvailableProcess")
...
Conout("Fim do método getAvailableProcess")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método startProcess")
...
cSoap += U_XSoapValue("attachments", ::oWSstartProcessattachments, oWSstartProcessattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.,.F.)
...
Conout("Fim do método startProcess")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAllActiveStates")
...
Conout("Fim do método getAllActiveStates")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método releaseProcess")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método releaseProcess")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método setTasksComments")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método setTasksComments")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método searchProcess")
...
Conout("Fim do método searchProcess")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAvailableUsersOnDemand")
...
Conout("Fim do método getAvailableUsersOnDemand")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getProcessFormId")
...
::Init()
::nresult            :=  WSAdvValue( oXmlRet,"_RESULT","int",NIL,NIL,NIL,"N",NIL,NIL)
Conout("Fim do método getProcessFormId")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método saveAndSendTaskClassic")
...
Conout("Fim do método saveAndSendTaskClassic")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAvailableUsersStartOnDemand")
...
Conout("Fim do método getAvailableUsersStartOnDemand")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAvailableUsers")
...
Conout("Fim do método getAvailableUsers")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getProcessImage")
...
Conout("Fim do método getProcessImage")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAttachments")
...
Conout("Fim do método getAttachments")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método importProcessWithCardAndPersistenceType")
...
Conout("Fim do método importProcessWithCardAndPersistenceType")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAvailableUsersStart")
...
Conout("Fim do método getAvailableUsersStart")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método importProcessWithCardAndGeneralInfo")
...
Conout("Fim do método importProcessWithCardAndGeneralInfo")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método takeProcessTaskByReplacement")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método takeProcessTaskByReplacement")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método exportProcess")
...
::Init()
::cresult            :=  WSAdvValue( oXmlRet,"_RESULT","string",NIL,NIL,NIL,"S",NIL,NIL)
Conout("Fim do método exportProcess")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método getAvailableStates")
...
Conout("Fim do método getAvailableStates")
END WSMETHOD
...
BEGIN WSMETHOD
Conout("Inicio do método updateWorkflowAttachment")
...
BEGIN WSMETHOD
Conout("Inicio do método getHistories")
...
Conout("Fim do método getHistories")
END WSMETHOD
...
//	WSDATA   cfilecontent              AS string OPTIONAL
...
WSMETHOD SOAPRECV WSSEND   WSCLIENT ECMWorkflowEngineServiceService_attachment
	Local oNode5
	::Init()
	If oResponse = NIL ; Return ; Endif
