...
Static Function MenuDef()
	...
	AAdd(aRotina,{"Visualizar" 		, "VIEWDEF.xKPTPerfil"    	, 0, 2 } )
	AAdd(aRotina,{"Incluir" 		, "VIEWDEF.xKPTPerfil"    	, 0, 3 } )
	AAdd(aRotina,{"Alterar" 		, "VIEWDEF.xKPTPerfil"    	, 0, 4 } )
	AAdd(aRotina,{"Excluir" 		, "VIEWDEF.xKPTPerfil"    	, 0, 5 } )
	AAdd(aRotina,{"Copiar" 			, "VIEWDEF.xKPTPerfil"    	, 0, 9 } )
