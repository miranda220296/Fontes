...
Menu do Monitor Integra��o Log de Sa�da
@author CDE - C�lula de Desenvolvimento Especifico
@Project MAN0000007423041_EF_000 - Log de Sa�da
*/
Static Function MenuDef()
	...
	Aadd(aRot , {"Visualizar"    , "VIEWDEF.F0700003"        , 0, 2})
	Aadd(aRot , {"Executar"    , "U_F07ExP20(1)"        , 0, 4})
	Aadd(aRot , {"Baixar"    , "U_F07ExP20(2)"        , 0, 4})
	
Return aRotina

/*{Protheus.doc} ModelDef
Modelo de dados do Monitor Integra��o Log de Sa�da
@author CDE - C�lula de Desenvolvimento Especifico
@Project MAN0000007423041_EF_000 - Log de Sa�da
*/
...
Tela do Monitor Integra��o Log de Sa�da
@author CDE - C�lula de Desenvolvimento Especifico
@Project MAN0000007423041_EF_000 - Log de Sa�da
*/
...
Valida��o dos status para execu��o
@author Alex Sandro
@since 27/12/2016
@Project MAN0000007423041_EF_000 - Log de Sa�da
*/
User Function F07ExP20(nBtn)
	If P20->P20_STATUS == "2"
		MsgStop('WS Client j� foi processado com sucesso anteriormente!!')
		Return
	EndIf
	
	If P20->P20_STATUS == "1" .and. ! Empty(P20->P20_DTHRR)
		MsgStop('WS Client j� foi reprocessado anteriormente!!')
		Return
	EndIf
	
	If nBtn == 1
		If P20->P20_STATUS == "0"
			MsgStop('WS Client j� foi baixada anteriormente!!')
			Return
		EndIf
	EndIf
	
	If ! MsgYesno("Confirma a execu��o do WSC?")
		Return
	EndIf
...
Static Function ExecP20()
	...
	If "(" $ P20->P20_INPUT
		...
		// no input a fun��o poder� ter somente parametros com string e com a opcao de NIL
